  ...
  function Home() {
    ...
    <div className="text-center px-4 max-w-6xl mx-auto mt-20">
      ...
      <img src="Variant2.png" alt="Smarthub" className="mt-10 rounded-2xl mx-auto max-w-full" />

      <p className="text-lg mt-10 mb-20">Gör ditt hem smartare med Techflow Innovations avancerade smarta hub. Den fungerar som hjärtat i ditt smarta hem och kopplar samman alla dina enheter – från belysning och uppvärmning till säkerhetssystem och röstassistenter. Med en stabil och säker uppkoppling ser huben till att dina enheter kommunicerar sömlöst med varandra, oavsett märke eller plattform. Skapa automatiserade rutiner som förenklar din vardag och anpassa ditt hem precis som du vill ha det.</p>
      </div>
      </div>
    )
  }
